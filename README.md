...
<!--
**Neskykun/neskykun** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
--><!DOCTYPE HTML>
<html>
<head><title>Hai Kamuuu</title>
<!-- Created By L3M4R1 -->
<script>alert ('hai')
alert ('Mau jalan kemana kita??')</script>
...
tb5_messages[0] = "Wisata Banyu Biru Lowayu";
tb5_messages[1] = "Wisata Religi Setigi";
tb5_messages[2] = "Wisata Alam Gosari";
tb5_messages[3] = "Pantai Kelapa";
tb5_messages[4] = "Gwalk Surabaya";
tb5_messages[5] = "Junggle Cafee Trawas";
tb5_messages[6] = "Kemana Ini!!";
...
<font size="5"><font color="white" face="courier new">Mau kemana ini...Hay kamuuu</font>
<br><font size="5"><font color="white" face="courier new">Kalau ngak jadi yaudah aku pergi sendiri hahhahahah</font>
<br><font size="5"><font color="white" face="courier new">aku terlalu insecure!!! </font>
<br><font size="5"><font color="white" face="courier new">Ngaj kayak diaa yang kauu mauu!?</font>
<br><a href="https://api.whatsapp.com/send?phone=62895631775923&text=Ya%20aku%20Mau%20Terima"><input type="button" value="Yes I do" onclick="alert('Thanks yah udah mau trima aku apa ada nya');" style="font size="5"></a><><><><a href="https://api.whatsapp.com/send?phone=62895631775923&text=maaf%20aku%20nggabisa%20Terima"><input type="button" value=" Im sorry" onclick="alert('Baik lah kalau itu mau mu ^_^');" style="font size="5"></a>
